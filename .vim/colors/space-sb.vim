...
call s:HL('LineNr',                         s:gray5,    s:gray3,         'italic')
call s:HL('CursorLineNr',                   s:gray5,    s:gray2,    'none')
call s:HL('MatchParen',                     s:gray2,    s:pink,     'bold')
call s:HL('ModeMsg',                        s:green,    '',         'reverse')
call s:HL('MoreMsg',                        s:green,    '',         'reverse')
...
call s:HL('Question',                       s:green,    '',         'reverse')
...
call s:HL('WarningMsg',                     s:red,      '',         'reverse')
call s:HL('WildMenu',                       s:gray2,    s:blue,     '')

" Standard Syntax
call s:HL('Comment',                        s:gray4,    s:gray1,         'italic')
